...
export function AppUpdateMessenger() {
  ...
  useEffect(() => {
    // Dans l'app Android (bridge ColombesApp), l'app gère elle-même ses mises
    // à jour (vérification GitHub) — on ne montre pas le messager in-app.
    if (typeof window !== "undefined" && (window as any).ColombesApp?.isApp?.()) return;
