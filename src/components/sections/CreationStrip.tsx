 ...
 *
 * Les images viennent de GALLERY_CREATIONS (8 visuels signature générés
 * pour la maison et signés au vrai logo — médaillon fil d'or).
 */
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle={<span className="text-[#CDBDA8]">Robes, ensembles, layette & tenues assorties — cousus avec amour.</span>}
          tone="orange"
          className="!mb-8"
        />
